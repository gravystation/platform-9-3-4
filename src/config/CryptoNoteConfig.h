...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 1250902;
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 40; // 20 minutes
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(9446744073709551615);
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(4251034073709551615);
...
For example:
gravyd --print-genesis-tx --genesis-block-reward-address cubev2Fyavy8CXG8BPEbNeCHFZ1fuDCYCZ3vW5H5LXN4K2M2MHUpTENip9bbavpHvvPwb4NDkBWrNgURAd5DB38FHXWZyoBh4wW
...
*/
const char GENESIS_COINBASE_TX_HEX[] = "012801ff0001ffbfa89cf99eadff3a029e522e61d184e04f6de5c8acdb325de3c03cd278f350e9c95b068d5990648f1421010e09f39dedef400a5cbac78a4fdb2df73db1f335ee9466b77b829357bbe58593";
...
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1557690960;
...
const uint64_t MINIMUM_FEE                                   = UINT64_C(160000000);
...
/* The mixin to use by default with gravywallet and gravy-service */
...
const uint64_t DEFAULT_DUST_THRESHOLD                        = UINT64_C(16000000);
...
const char     CRYPTONOTE_NAME[]                             = "gravy";
...
const int      P2P_DEFAULT_PORT                              =  10969;
const int      RPC_DEFAULT_PORT                              =  10696;
const int      SERVICE_DEFAULT_PORT                          =  8968;
...
const char     LATEST_VERSION_URL[]                          = "http://latest.gravystation.org";
const std::string LICENSE_URL                                = "https://github.com/gravystation/platform-9-3-4/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0xb1, 0x5c, 0x7a, 0x4c, 0xbf, 0x56, 0x53, 0x48, 0x62, 0xf4, 0x98, 0xa3, 0xb4, 0xc4, 0x48, 0xe3  }
};

const char* const SEED_NODES[] = {
  "128.199.41.103:11897", //Alpha
  "157.230.222.38:11897", //Omega
};
} // CryptoNote
